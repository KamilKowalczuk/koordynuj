<script lang="ts">
	...
	// Lista naszych linków nawigacyjnych
	const navLinks = [
	...
	// Nasłuchujemy na scroll, aby zmienić wygląd nagłówka
...
>
	...
	{#if isOpen}
		<div 
			class="md:hidden fixed inset-0 top-[88px] bg-background-light z-50 flex flex-col items-center justify-center space-y-8"
		>
			{#each navLinks as link}
				<a 
					href={link.href} 
